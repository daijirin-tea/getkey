...
execute if score $getkey getkey_is_escaped matches 1 run return run function getkey:get2/in_string_in_escaped
...
execute if score $getkey getkey_success matches 0 run function getkey:get2/add_key
execute if score $getkey getkey_success matches 0 run scoreboard players set $getkey getkey_in_string 0

execute if score $getkey getkey_count matches 0 run function getkey:get2/add_key