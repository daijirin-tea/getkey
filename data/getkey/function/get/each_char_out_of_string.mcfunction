...
execute if data storage getkey: w.data{char:":"} run scoreboard players set $getkey getkey_count 1
execute if data storage getkey: w.data{char:":"} if score $getkey getkey_depth matches 0 if score $getkey getkey_is_reading_key matches 1 run function getkey:get/key_push
