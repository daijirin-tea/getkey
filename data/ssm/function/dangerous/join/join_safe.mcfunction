...
data modify storage ssm: w.input set from storage ssm: temporary.data.safe_list
...
data modify storage ssm: w.data.safe_str set from storage ssm: temporary.data.output